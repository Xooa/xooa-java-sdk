...
public class BlockchainApi {
	 ...
	 */
	public CurrentBlockResponse getCurrentBlock(WebService webService, String calloutBaseUrl)
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	public PendingTransactionResponse getCurrentBlockAsync(WebService webService, String calloutBaseUrl)
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public BlockResponse getBlockByNumber(WebService webService, String calloutBaseUrl, long blockNumber)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	public PendingTransactionResponse getBlockByNumberAsync(WebService webService, String calloutBaseUrl,
			long blockNumber) throws XooaApiException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public TransactionResponse getTransaction(WebService webService, String calloutBaseUrl, String transactionId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	public PendingTransactionResponse getTransactionAsync(WebService webService, String calloutBaseUrl,
			String transactionId) throws XooaApiException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	private TransactionResponse callTransactionApi(WebService webService, String url, String requestMethod)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	private CurrentBlockResponse callBlockchainApi(WebService webService, String url, String requestMethod)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	private BlockResponse callBlockApi(WebService webService, String url, String requestMethod)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	private PendingTransactionResponse callBlockchainApiAsync(WebService webService, String url, String requestMethod)
			throws XooaApiException {
