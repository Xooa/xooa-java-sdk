...
public class InvokeApi {
	 ...
	 */
	public InvokeResponse invoke(WebService webService, String calloutBaseUrl, String functionName, String[] args)
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	public PendingTransactionResponse invokeAsync(WebService webService, String calloutBaseUrl, String functionName,
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	private PendingTransactionResponse callInvokeApiAsync(WebService webService, String url, String[] args)
