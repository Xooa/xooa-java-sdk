...
public class ResultApi {
	 ...
	 */
	public InvokeResponse getResultForInvoke(WebService webService, String calloutBaseUrl, String resultId)
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public QueryResponse getResultForQuery(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public IdentityResponse getResultForIdentity(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public CurrentBlockResponse getResultForCurrentBlock(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public BlockResponse getResultForBlockByNumber(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public TransactionResponse getResultForTransaction(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @param calloutBaseUrl the base url where the app is running
	 * @param resultId       result id from a previous blockchain transaction
	 * @return boolean true if the identity was deleted false otherwise.
	 * @throws XooaApiException            It is thrown in case of any internal error or if the API returns any error.
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	public boolean getResultForDeleteIdentity(WebService webService, String calloutBaseUrl, String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
