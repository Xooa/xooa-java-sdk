...
public class QueryApi {
	 ...
	 */
	public QueryResponse query(WebService webService, String calloutBaseUrl, String functionName, String[] args)
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	public PendingTransactionResponse queryAsync(WebService webService, String calloutBaseUrl, String functionName,
			String[] args) throws XooaApiException {
	 ...
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to API returns a pending response due to timeout.
	 */
	private QueryResponse callQueryApi(WebService webService, String url, String[] args)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @throws XooaApiException It is thrown in case of any internal error or if the API returns any error.
	 */
	private PendingTransactionResponse callQueryApiAsync(WebService webService, String url, String[] args)
