...
/**
 * Base class to connect with the Xooa Blockchain PaaS. This class provides all the methods exposed by the SDK.
 *
 * @author kavi
 *
 */
public class XooaClient {
	...
	public XooaClient(String apiToken, IEventListener eventListener) {
		...
		// Creates a new instance of webservice class and sets it using the setter
		// method
		setWebService(new WebService(apiToken));
	}
	 ...
	 * submitting transaction for processing by the blockchain Smart Contract app.
	 * The end point must call a function already defined in your Smart Contract app
	 * which will process the Invoke request. The function name is part of the
	 * endpoint URL, or can be entered as the fcn parameter when testing using the
	 * Sandbox. For example, if testing the sample get-set Smart Contract app, use
	 * ‘set’ (without quotes) as the value for fcn. The function arguments (number
	 * of arguments and type) is determined by the Smart Contract. The Smart
	 * Contract is also responsible for arguments validation and exception
	 * management. The payload object of Invoke Transaction Response in case of
	 * Final Response is determined by the Smart Contract app. A success response
	 * may be either 200 or 202.
	 *
	 ...
	 */
	public InvokeResponse invoke(String functionName, String[] args)
	 ...
	 * @param functionName Function name to invoke as defined in the smart contract
	 * @param args         Arguments to pass to the smart contract
	 * @param timeout      The Timeout time to wait before converting the request to
	 *                     async
	 * @return InvokeResponse Gives the Transaction Id and payload from Xooa
	 * @throws XooaApiException            It is thrown in case of any internal
	 *                                     error or if the API returns any error.
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to
	 *                                     API returns a pending response due to
	 *                                     timeout.
	 */
	public InvokeResponse invoke(String functionName, String[] args, long timeout)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @param functionName Function name to invoke as defined in the smart contract
	 * @param args         Arguments to pass to the smart contract
	 * @return PendingTransactionResponse Gives the ResultId and ResultUrl for the
	 *         transaction
	 ...
	 * validation and exception management. For example, if testing the sample
	 * get-set Smart Contract app, enter ‘get’ (without quotes) as the value for
	 * fcn. The response body is also determined by the Smart Contract app, and
	 * that’s also the reason why a consistent response sample is unavailable for
	 ...
	 *                                     timeout.
	 */
	public QueryResponse query(String functionName, String[] args)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *                                     timeout.
	 */
	public QueryResponse query(String functionName, String[] args, long timeout)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *
	 * @return IdentityResponse Gives the details about the Identity and the access
	 *         priviliges
	 * @throws XooaApiException            It is thrown in case of any internal
	 *                                     error or if the API returns any error.
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to
	...
	/**
	 * Get all identities from the identity registry Required permission: manage
	 * identities (canManageIdentities=true)
	 *
	 * @return IdentityResponse Gives the details about the Identity and the access
	 *         priviliges
	 * @throws XooaApiException            It is thrown in case of any internal
	...
	/**
	 * The Enroll identity endpoint is used to enroll new identities for the smart
	 * contract app. A success response includes the API Token generated for the
	 * identity. This API Token can be used to call API End points on behalf of the
	 * enrolled identity.
	 *
	 * This endpoint provides equivalent functionality to adding new identity
	 * manually using Xooa console, and identities added using this endpoint will
	 * appear, and can be managed, using Xooa console under the identities tab of
	 * the smart contract app.
	 *
	 * Required permission: manage identities (canManageIdentities=true)
	 *
	 * @param identityRequest Idnetity Request giving the name, priviliges and
	 *                        attributes related to the new identity
	 * @return IdentityResponse Gives the details about the Identity and the access
	 *         priviliges
	 * @throws XooaApiException            It is thrown in case of any internal
	 *                                     error or if the API returns any error.
	 ...
	 *                                     timeout.
	 */
	public IdentityResponse enrollIdentity(IdentityRequest identityRequest)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 * @param identityRequest Idnetity Request giving the name, priviliges and
	 *                        attributes related to the new identity
	 * @param timeout         The Timeout time to wait before converting the request
	 *                        to async
	 * @return IdentityResponse Gives the details about the Identity and the access
	 *         priviliges
	 * @throws XooaApiException            It is thrown in case of any internal
	 ...
	 *                                     timeout.
	 */
	public IdentityResponse enrollIdentity(IdentityRequest identityRequest, long timeout)
			throws XooaApiException, XooaRequestTimeoutException {
	...
	/**
	 * Generates new identity API Token Required permission: manage identities
	 ...
	 *                                     timeout.
	 */
	public IdentityResponse regenerateIdentityApiToken(String identityId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *                                     timeout.
	 */
	public IdentityResponse regenerateIdentityApiToken(String identityId, long timeout)
			throws XooaApiException, XooaRequestTimeoutException {
	...
	/**
	 * Get the specified identity from the identity registry Required permission:
	 * manage identities (canManageIdentities=true)
	 *
	 * @param identityId Id of the identity to regenerate API Token for
	 * @return IdentityResponse Gives the details about the Identity and the access
	 *         priviliges
	...
	/**
	 * Deletes an identity. Required permission: manage identities
	 * (canManageIdentities=true)
	 *
	 * @param identityId Id of the identity to regenerate API Token for
	 * @return IdentityResponse Gives the details about the Identity and the access
	 ...
	 *                                     timeout.
	 */
	public boolean deleteIdentity(String identityId, long timeout)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *
	 * @return CurrentBlockResponse Gives the details about the block number and the
	 *         hashes
	 * @throws XooaApiException            It is thrown in case of any internal
	 *                                     error or if the API returns any error.
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to
	...
	/**
	 * Use this endpoint to Get the number of transactions and hashes of a specific
	 * block in the network parameters
	 *
	 * @param blockNumber block number to get the data for
	 * @return BlockResponse gives the block number, number of transaction and
	 *         hashes for the block
	 * @throws XooaApiException            It is thrown in case of any internal
	 *                                     error or if the API returns any error.
	 * @throws XooaRequestTimeoutException It is thrown when a synchronous call to
	 *                                     API returns a pending response due to
	 ...
	 *                                     timeout.
	 */
	public CurrentBlockResponse getResultForCurrentBlock(String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *                                     timeout.
	 */
	public BlockResponse getResultForBlockByNumber(String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
	 ...
	 *                                     timeout.
	 */
	public TransactionResponse getResultForTransaction(String resultId)
			throws XooaApiException, XooaRequestTimeoutException {
		...
		try {
			...
			socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
				...
				public void call(Object... args) {
					...
					iEventListener
							.onConnected("Connection successful. Trying authentication with ApiToken " + apiToken);
